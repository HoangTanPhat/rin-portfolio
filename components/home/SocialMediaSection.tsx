...
export default function SocialMediaSection({
  ...
  return (
    <AnimateSection id="social-media-post">
      {!noTitle && (
        <h2 className="text-xl md:text-2xl text-textSecondary my-4 md:my-8">
          Social Media Post
        </h2>
      )}
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 w-full mb-3">
        ...
        <div className="relative aspect-square ">
          <ImageWithText
            src={physiogelMedia}
            title="BRAND: PHYSIOGEL"
            href="/social-media-post/physiogel"
          />
        </div>
        <div className="relative aspect-square">
          <ImageWithText
            src={pulseInnovatesMedia}
